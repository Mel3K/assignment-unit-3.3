...
let partsNeeded = 40;
console.log('partsNeeded should be 40', partsNeeded);
...
console.log("supplyChanges should be an array 6 numbers", supplyChanges);
...
console.log('added item 25 to end of array',supplyChanges);
